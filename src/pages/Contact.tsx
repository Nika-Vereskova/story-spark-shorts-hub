...
const Contact = () => {
  return (
    <div className="min-h-screen bg-parchment bg-gear-pattern relative">
      ...
      <SEO title="Contact STEaM LOGIC Studio AB | AI Consulting & Custom GPT Development" description="Contact STEaM LOGIC Studio AB for AI consulting, custom GPT development, automation solutions, and AI strategy. Led by CEO Renata Khakimova." />

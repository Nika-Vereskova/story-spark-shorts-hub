        ...
        <div className="pt-24 pb-16 px-6">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center">
              ...
              <p className="text-oxidized-teal mt-4 font-playfair">Loading...</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <Card className="bg-parchment/90 border-2 border-brass shadow-brass-drop">
              ...
              <CardContent className="text-center">
                <Button
                  ...
                  className="bg-brass hover:bg-brass-dark text-parchment px-8 py-3 border-2 border-brass-dark shadow-inner-glow transition-all duration-300 font-playfair font-medium"
                >
                  Sign In
                </Button>
              </CardContent>
        ...
        <div className="pt-24 pb-16 px-6">
          <div className="container mx-auto max-w-4xl">
            <Card className="bg-parchment/90 border-2 border-brass shadow-brass-drop">
              ...
              <CardContent className="text-center">
                <p className="text-oxidized-teal/70 font-playfair">
            ...
            <Card className="bg-parchment/90 border-2 border-brass shadow-brass-drop">
              ...
              <CardContent>
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-playfair text-oxidized-teal">
          ...
          <Card className="bg-parchment/90 border-2 border-brass shadow-brass-drop relative">
            ...
            <CardContent>
              <form onSubmit={handleSendNewsletter} className="space-y-6">
                <div>
                  <label htmlFor="subject" className="block text-oxidized-teal font-playfair font-medium mb-2">
                    Subject Line
                  </label>
                  <Input
                    id="subject"
                    ...
                    disabled={isSending}
                    className="w-full px-4 py-3 bg-parchment border-2 border-brass focus:border-brass-dark focus:outline-none shadow-inner-glow font-playfair"
                    maxLength={100}
                  />
                </div>

                <div>
                  <label htmlFor="content" className="block text-oxidized-teal font-playfair font-medium mb-2">
                    Newsletter Content
                  </label>
                  <Textarea
                    id="content"
                    ...
                    disabled={isSending}
                    className="w-full px-4 py-3 bg-parchment border-2 border-brass focus:border-brass-dark focus:outline-none shadow-inner-glow font-playfair min-h-[200px]"
                    maxLength={5000}
                  />
                  <p className="text-sm text-oxidized-teal/60 mt-1 font-playfair">
                ...
                <Button
                  ...
                  className="w-full bg-brass hover:bg-brass-dark text-parchment px-8 py-4 border-2 border-brass-dark shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-playfair font-medium disabled:opacity-50 text-lg"
                >
                  {isSending ? (
                    <>

...
const About = () => {
  return (
    <div className="min-h-screen bg-parchment bg-gear-pattern relative">
      ...
      <SEO title="About CEO Renata Khakimova | STEaM LOGIC Studio AB" description="Meet Renata Khakimova, CEO of STEaM LOGIC Studio AB. Expert in AI strategy, custom GPT development, and intelligent automation. Publishes creative works as author Nika Vereskova." />

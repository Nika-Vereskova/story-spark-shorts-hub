...
const Moved = () => {
 ...
 <p className="text-xl text-brass mb-4 ">
 {t('moved.subtitle')}
 </p>
 <p className="text-lg text-oxidized-teal mb-6 ">
 {t('moved.description')}
 </p>
 ...
 className="inline-block bg-brass hover:bg-brass-dark text-parchment px-8 py-3 border-2 border-brass-dark shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-medium rounded text-lg"
 >

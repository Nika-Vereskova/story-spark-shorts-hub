      ...
      <div className="pt-24 pb-16 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-oxidized-teal mb-4 drop-shadow-text-drop">{t('blog.title')}</h1>
          ...
          {showCreateForm && isAdmin && (
            <Card className="mb-8 bg-parchment/90 border-2 border-brass shadow-brass-drop">
              <CardHeader>
                <CardTitle className="font-bold text-oxidized-teal">{t('common.createPost')}</CardTitle>
              </CardHeader>
            ...
            {posts.map((post, index) => (
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardTitle className="font-bold text-oxidized-teal text-2xl drop-shadow-text-drop">{post.title}</CardTitle>
                ...
                <CardContent className="space-y-6">
                  ...
                  {post.links && post.links.length > 0 && (
                    <div className="space-y-4">
                      <h3 className="text-oxidized-teal font-semibold flex items-center">

            ...
            {user && isAdmin && (
              <div className="mt-8">
                <Button
                  ...
                  className="bg-brass hover:bg-brass-dark text-parchment px-6 py-3 border-2 border-brass-dark shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-playfair font-medium"
                >
          ...
          {user && !isAdmin && !roleLoading && (
            <div className="mt-8 p-4 bg-brass/10 border border-brass/30 rounded-lg">
              <div className="flex items-center text-brass">
                ...
                <span className="font-playfair text-sm">Blog post creation is restricted to administrators.</span>
              </div>
            </div>
          )}
          ...
          {showCreateForm && isAdmin && (
            <Card className="mb-8 bg-parchment/90 border-2 border-brass shadow-brass-drop">
              ...
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="post-title" className="text-oxidized-teal font-playfair font-medium">
                    {t('common.postTitle')}
                  </Label>
                  <Input
                    id="post-title"
                ...
                <div>
                  <Label htmlFor="post-content" className="text-oxidized-teal font-playfair font-medium">
                ...
                <div>
                  <Label htmlFor="webhook-url" className="text-oxidized-teal font-playfair font-medium">
                ...
                <div className="flex gap-3 pt-4">
                  <Button
                    ...
                    disabled={isLoading}
                    className="bg-brass hover:bg-brass-dark text-parchment px-4 py-2 border-2 border-brass-dark shadow-inner-glow transition-all duration-300 font-playfair font-medium"
                  >
              ...
              >
                ...
                <CardHeader>
                  <div className="flex items-center gap-2 text-brass mb-2">
                    ...
                    <span className="text-sm font-medium font-playfair">{post.date}</span>
                  </div>
                  <CardTitle className="text-oxidized-teal text-2xl font-playfair drop-shadow-text-drop">{post.title}</CardTitle>
                  <CardDescription className="text-brass font-medium font-playfair">{t('blog.latestUpdates')}</CardDescription>
                </CardHeader>
                
                <CardContent className="space-y-6">
                  <div className="text-oxidized-teal/80 font-playfair whitespace-pre-line leading-relaxed">
                    {post.content}
                  </div>
                  ...
                  {post.bookExcerpt && (
                    <div className="pt-4 border-t border-brass/30">
                      <Button
                        variant="outline"
                        className="border-2 border-oxidized-teal text-oxidized-teal hover:bg-oxidized-teal/10 shadow-inner-glow transition-all duration-300 font-playfair font-medium mb-4"
                      ...
                      {expandedExcerpt && (
                        <div className="bg-brass/5 p-6 rounded-lg border border-brass/20 animate-fade-in">
                          <div className="prose prose-oxidized-teal max-w-none">
                            <div className="text-oxidized-teal/80 font-playfair whitespace-pre-line leading-relaxed text-sm">
                              {post.bookExcerpt}
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="pt-4 border-t border-brass/30">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <Button
                        variant="outline"
                        className="border-2 border-oxidized-teal text-oxidized-teal hover:bg-oxidized-teal/10 shadow-inner-glow transition-all duration-300 font-playfair font-medium"
                  ...
                  <div className="pt-4 italic text-oxidized-teal/70 font-playfair">

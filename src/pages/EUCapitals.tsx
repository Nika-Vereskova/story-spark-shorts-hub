...
const EU_COUNTRIES = [
  {
    ...
    capital_ru: 'Вена',
    region: 'Central',
    hint_en: 'Austria → Wiener sausage → Vienna',
    hint_sv: 'Österrike → wienerkorv → Wien'
  },
  {
    code: 'BE',
    country_en: 'Belgium',
    ...
    capital_ru: 'Брюссель',
    region: 'Western',
    hint_en: 'BELly full of Brussels sprouts',
    hint_sv: 'BELgien → Brysselkål → Bryssel'
  },
  {
    code: 'BG',
    country_en: 'Bulgaria',
    ...
    capital_ru: 'София',
    region: 'Eastern',
    hint_en: "Bulgarian 'sofa' → Sofia",
    hint_sv: "Bulgarisk 'soffa' → Sofia"
  },
  {
    code: 'HR',
    country_en: 'Croatia',
    ...
    capital_ru: 'Загреб',
    region: 'Southern',
    hint_en: 'ZAG tag for Croatia → Zagreb',
    hint_sv: 'KROatien → ZAG (flygkod) → Zagreb'
  },
  {
    code: 'CY',
    country_en: 'Cyprus',
    ...
    capital_ru: 'Никосия',
    region: 'Southern',
    hint_en: 'Nice sea around Cyprus → Nicosia',
    hint_sv: 'Nice sea runt Cypern → Nicosia'
  },
  {
    code: 'CZ',
    country_en: 'Czechia',
    ...
    capital_ru: 'Прага',
    region: 'Central',
    hint_en: 'Check → Czech → Prague',
    hint_sv: 'Tjeckien → Prag'
  },
  {
    code: 'DK',
    country_en: 'Denmark',
    ...
    country_sv: 'Danmark',
    capital_sv: 'Köpenhamn',
    country_ru: 'Дания',
    capital_ru: 'Копенгаген',
    region: 'Nordic',
    hint_en: 'Open‑face sandwiches in Copenhagen',
    hint_sv: "Tänk 'köpa hamn' → Köpenhamn"
  },
  {
    code: 'EE',
    country_en: 'Estonia',
    ...
    capital_ru: 'Таллин',
    region: 'Baltic',
    hint_en: 'A tall inn → Tallinn',
    hint_sv: "Ett 'tall' inn → Tallinn"
  },
  {
    code: 'FI',
    country_en: 'Finland',
    capital_en: 'Helsinki',
    country_sv: 'Finland',
    capital_sv: 'Helsingfors',
    country_ru: 'Финляндия',
    capital_ru: 'Хельсинки',
    region: 'Nordic',
    hint_en: 'HEL → Helsinki (easy to spot)',
    hint_sv: 'HEL → Helsingfors'
  },
  {
    code: 'FR',
    country_en: 'France',
    ...
    capital_ru: 'Париж',
    region: 'Western',
    hint_en: 'PAR → Paris (Eiffel)',
    hint_sv: 'PAR → Paris (Eiffeltornet)'
  },
  {
    code: 'DE',
    country_en: 'Germany',
    ...
    capital_ru: 'Берлин',
    region: 'Central',
    hint_en: 'BERlin in GERmany',
    hint_sv: 'BERlin i Tyskland'
  },
  {
    code: 'GR',
    country_en: 'Greece',
    ...
    capital_ru: 'Афины',
    region: 'Southern',
    hint_en: 'Greek athlete → Athens',
    hint_sv: 'Grekisk atlet → Aten'
  },
  {
    code: 'HU',
    country_en: 'Hungary',
    ...
    capital_ru: 'Будапешт',
    region: 'Central',
    hint_en: 'Hungry? Try a BUDa‑pastry → Budapest',
    hint_sv: 'Hungrig? BUDa‑bakelse → Budapest'
  },
  {
    code: 'IE',
    country_en: 'Ireland',
    ...
    capital_ru: 'Дублин',
    region: 'Western',
    hint_en: 'Dublin → double in (two leaves of clover)',
    hint_sv: 'Dublin → dubbelt in (shamrock)'
  },
  {
    code: 'IT',
    country_en: 'Italy',
    ...
    capital_ru: 'Рим',
    region: 'Southern',
    hint_en: 'Romans in Rome',
    hint_sv: 'Romarna i Rom'
  },
  {
    code: 'LV',
    country_en: 'Latvia',
    ...
    capital_ru: 'Рига',
    region: 'Baltic',
    hint_en: 'Latte in Riga',
    hint_sv: 'Latte i Riga'
  },
  {
    code: 'LT',
    ...
    capital_ru: 'Вильнюс',
    region: 'Baltic',
    hint_en: 'Vilnius → "will‑new‑house"',
    hint_sv: 'Vilnius → "vill‑nytt‑hus"'
  },
  {
    code: 'LU',
    ...
    capital_sv: 'Luxemburg',
    country_ru: 'Люксембург',
    capital_ru: 'Люксембург',
    region: 'Western',
    hint_en: 'Lux = light; tiny but bright',
    hint_sv: 'Lux = ljus; litet men ljust'
  },
  {
    code: 'MT',
    country_en: 'Malta',
    ...
    capital_ru: 'Валлетта',
    region: 'Southern',
    hint_en: 'Valley → Valletta',
    hint_sv: 'Dal → Valletta'
  },
  {
    code: 'NL',
    ...
    capital_sv: 'Amsterdam',
    country_ru: 'Нидерланды',
    capital_ru: 'Амстердам',
    region: 'Western',
    hint_en: 'Dams on the Amstel → Amsterdam',
    hint_sv: 'Damm på Amstel → Amsterdam'
  },
  {
    code: 'PL',
    country_en: 'Poland',
    ...
    capital_ru: 'Варшава',
    region: 'Eastern',
    hint_en: 'POLAND: WAR‑SAW',
    hint_sv: 'POLEN: WAR‑SAW → Warszawa'
  },
  {
    code: 'PT',
    country_en: 'Portugal',
    ...
    capital_ru: 'Лиссабон',
    region: 'Western',
    hint_en: '"Listen" to Fado in Lisbon',
    hint_sv: 'Lyssna (Lis-) på fado i Lissabon'
  },
  {
    code: 'RO',
    country_en: 'Romania',
    ...
    capital_ru: 'Бухарест',
    region: 'Eastern',
    hint_en: 'Book a rest → Bucharest',
    hint_sv: 'Boka rast → Bukarest'
  },
  {
    code: 'SK',
    country_en: 'Slovakia',
    ...
    capital_sv: 'Bratislava',
    country_ru: 'Словакия',
    capital_ru: 'Братислава',
    region: 'Central',
    hint_en: 'SLOvakia & BratisLAva share "SLA"',
    hint_sv: 'SLOvakien & BratisLAva delar "SLA"'
  },
  {
    code: 'SI',
    country_en: 'Slovenia',
    ...
    capital_sv: 'Ljubljana',
    country_ru: 'Словения',
    capital_ru: 'Любляна',
    region: 'Central',
    hint_en: 'Ljub‑ means "love" → lovely Ljubljana',
    hint_sv: 'Ljub‑ betyder "kärlek" → Ljubljana'
  },
  {
    code: 'ES',
    country_en: 'Spain',
    ...
    capital_ru: 'Мадрид',
    region: 'Southern',
    hint_en: 'Real Madrid helps remember Madrid',
    hint_sv: 'Tänk "Real Madrid" → Madrid'
  },
  {
    code: 'SE',
    country_en: 'Sweden',
    ...
    country_sv: 'Sverige',
    capital_sv: 'Stockholm',
    country_ru: 'Швеция',
    capital_ru: 'Стокгольм',
    region: 'Nordic',
    hint_en: 'Stock‑holm: keep stock on the islets',
    hint_sv: 'Stock‑holm: stock på holmarna'
  }
];
...
const EUCapitals = () => {
  ...
  const getLocalizedField = (item: any, field: 'country' | 'capital') => {
    switch (locale) {
      case 'sv':
        return item[`${field}_sv`];
      case 'ru':
  ...
  const getDisplayText = (item: any, isQuestion: boolean, dir: string) => {
    if (dir === 'country') {
      return isQuestion
        ? getLocalizedField(item, 'country')
        : getLocalizedField(item, 'capital');
    } else {
      return isQuestion
        ? getLocalizedField(item, 'capital')
        : getLocalizedField(item, 'country');
  ...
  const speak = (text: string) => {
    if ('speechSynthesis' in window) {
      try {
        ...
        utterance.lang = langMap[locale] || 'en-GB';
  ...
  const renderMultipleChoice = (question: string, answer: string, item: any) => {
    const wrongAnswers = shuffle(
      ...
      return quizDirection === 'cc'
        ? getLocalizedField(x, 'capital')
        : getLocalizedField(x, 'country');
    });
  ...
  const hintText = showHints ? (locale === 'sv' ? currentItem.hint_sv : currentItem.hint_en) : '';
                ...
                <div className="steampunk-card min-h-[400px] flex items-center justify-center p-8">
                  {(() => {
                    ...
                    const questionText = isCountryToCapital
                      ? getLocalizedField(currentQuestion.item, 'country')
                      : getLocalizedField(currentQuestion.item, 'capital');
            ...
            <div className="steampunk-card p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {filteredCountries.map(country => {
                  const name = getLocalizedField(country, 'country');
                  const capital = getLocalizedField(country, 'capital');

            ...
            {books.map((book, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  {book.featured && (
                    <div className="absolute top-4 right-4 z-20">
                      <span className="px-3 py-1 bg-brass/90 text-parchment border border-brass-dark font-medium font-playfair flex items-center">
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-brass font-medium font-playfair">{book.ageRange}</CardDescription>
                </CardHeader>

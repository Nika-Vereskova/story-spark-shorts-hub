        ...
        <div className="container mx-auto px-6 py-3">
          ...
          {isOpen && (
            <>
              ...
              {/* Drawer Panel */}
              <div className="fixed inset-y-0 left-0 w-[88vw] max-w-sm bg-parchment z-50 md:hidden shadow-2xl animate-in slide-in-from-left duration-300 border-r border-brass/20">

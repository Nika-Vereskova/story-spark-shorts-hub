      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-oxidized-teal/80 mb-8 max-w-2xl font-playfair">
              {t('home.subtitle')}
              <br /><br />
              {t('home.description')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="bg-brass hover:bg-brass-dark text-parchment px-8 py-3 text-lg border-2 border-brass-dark shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-playfair font-medium"
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-oxidized-teal text-oxidized-teal hover:bg-oxidized-teal/10 px-8 py-3 text-lg shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-playfair font-medium hover:sepia"
          ...
          <div className="animate-scale-in">
            <Card className="bg-parchment/90 border-2 border-brass hover:border-brass-dark transition-all duration-300 hover:scale-105 shadow-brass-drop relative overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="text-brass font-medium font-playfair">{t('common.ageRange')} • Steampunk Fairy Tale</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-oxidized-teal/80 mb-6 font-playfair">

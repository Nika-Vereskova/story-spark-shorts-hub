      ...
      {services.map((service, index) => (
        <Card key={index} className="bg-parchment/90 border-2 border-brass shadow-brass-drop hover:shadow-brass-glow transition-all duration-300 hover:scale-105 relative group">
          ...
          <CardContent className="space-y-4">
            ...
            <Button 
              className="w-full bg-brass hover:bg-brass-dark text-parchment border-2 border-brass-dark shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-inter font-medium mt-6"

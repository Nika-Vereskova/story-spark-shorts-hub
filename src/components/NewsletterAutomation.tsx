      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card className="bg-parchment/90 border-2 border-brass">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-oxidized-teal/80 font-playfair">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="bg-brass/10 p-4 rounded border border-brass/30">
              ...
              <ul className="text-sm text-oxidized-teal/80 space-y-1 font-playfair">
            ...
            <Button 
              ...
              className="w-full bg-oxidized-teal hover:bg-oxidized-teal-light text-parchment font-playfair"
            >
      ...
      <Card className="bg-parchment/90 border-2 border-brass">
        ...
        <CardContent className="space-y-4">
          <div className="bg-brass/10 p-4 rounded border border-brass/30">
            ...
            <ol className="text-sm text-oxidized-teal/80 space-y-1 font-playfair list-decimal list-inside">
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="zapier-webhook" className="font-playfair">Zapier Webhook URL</Label>
              <Input
                id="zapier-webhook"
                type="url"
            ...
            <Button 
              ...
              className="w-full bg-brass hover:bg-brass-dark text-parchment font-playfair"
            >
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2 text-sm font-playfair">
            ...
            <div>
              ...
              <div className="space-y-1 text-sm font-playfair">

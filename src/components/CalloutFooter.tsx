...
const CalloutFooter = () => {
 ...
 return (
 <section className="py-16 md:py-24 px-6 bg-gradient-to-r from-brass/20 via-oxidized-teal/20 to-brass/20 relative overflow-hidden">
 ...
 <p className="text-xl text-oxidized-teal/80 mb-12 max-w-2xl mx-auto leading-relaxed">
 ...
 <Button 
 size="lg"
 className="bg-brass hover:bg-brass-dark text-parchment px-8 py-4 text-lg border-2 border-brass-dark shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-medium"
 ...
 size="lg"
 variant="outline"
 className="border-2 border-oxidized-teal text-oxidized-teal hover:bg-oxidized-teal/10 px-8 py-4 text-lg shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-medium"
 ...
 {/* Trust indicators */}
 <div className="mt-12 flex flex-wrap justify-center gap-8 text-sm text-oxidized-teal/60 ">

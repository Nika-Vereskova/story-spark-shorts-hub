  ...
  return (
    <footer className="py-8 px-6 bg-parchment/50 border-t-2 border-brass/50">
      <div className="container mx-auto text-center">
        <p className="text-oxidized-teal/80 font-medium font-playfair">{t('footer.copyright')}</p>
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex justify-center space-x-6">
            <a 
              ...
              className="text-brass hover:text-brass-dark transition-colors font-playfair hover:sepia"
            >
              {t('contact.youtube')}
            </a>
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-brass hover:text-brass-dark transition-colors font-playfair"
            >
              {t('contact.instagram')}
            </a>
            <a 
          ...
          <div className="flex-1 flex justify-end">
            {visitCount && (
              <span className="text-oxidized-teal/60 font-playfair text-xs">
        ...
        <div className="flex justify-center space-x-6 mt-4">
          <Link 
            to="/privacy" 
            className="text-oxidized-teal/80 hover:text-oxidized-teal transition-colors font-playfair text-sm"
          >
            {t('footer.privacy')}
          </Link>
          <Link 

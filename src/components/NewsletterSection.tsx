...
const NewsletterSection = () => {
 ...
 return (
 <section className="py-16 md:py-24 px-6 bg-gradient-to-r from-brass/20 to-oxidized-teal/20">
 ...
 className="flex-1 px-4 py-3 bg-parchment border-2 border-brass focus:border-brass-dark focus:outline-none shadow-inner-glow "
 aria-label="Email address for newsletter"
 />
 <Button 
 type="submit"
 disabled={isSubmitting}
 className="bg-brass hover:bg-brass-dark text-parchment px-8 border-2 border-brass-dark shadow-inner-glow transition-all duration-300 hover:animate-steam-puff font-medium disabled:opacity-50"
 >

...
import { Cog, ChevronDown, Settings, Wrench, Gauge, Zap } from 'lucide-react';
...
const NewHeroSection = () => {
  ...
  return (
    ...
    >
      {/* Enhanced Mechanical Background with Multiple Elements */}
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 opacity-15">
          <Settings className="w-full h-full text-oxidized-teal gear-counter" />
        </div>
        <div className="absolute bottom-32 left-1/4 w-20 h-20 opacity-10">
          <Cog className="w-full h-full text-brass gear-clockwise" style={{ animationDuration: '18s' }} />
        </div>
        <div className="absolute bottom-20 right-1/3 w-16 h-16 opacity-15">
          <Wrench className="w-full h-full text-oxidized-teal mechanical-tick" />
        </div>
        
        {/* Additional mechanical elements */}
        <div className="absolute top-1/3 left-5 w-12 h-12 opacity-8">
          <Gauge className="w-full h-full text-brass mechanical-tick" />
        </div>
        <div className="absolute top-2/3 right-5 w-14 h-14 opacity-8">
          <Zap className="w-full h-full text-oxidized-teal" style={{ animation: 'pulse 3s ease-in-out infinite' }} />
        </div>
        <div className="absolute bottom-1/2 left-1/2 w-8 h-8 opacity-5 transform -translate-x-1/2">
          <Settings className="w-full h-full text-brass gear-counter" style={{ animationDuration: '25s' }} />
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        <header className="animate-fade-in">
          {/* 3D Company Logo with enhanced mechanical frame */}
          <div className="flex justify-center mb-1 sm:mb-6 relative">
            {/* Decorative mechanical frame around logo */}
            ...
            <div className="absolute -bottom-4 -left-4 w-6 h-6 opacity-30">
              <Settings className="w-full h-full text-brass gear-counter" />
            </div>
            <div className="absolute -bottom-4 -right-4 w-6 h-6 opacity-30">
              <Gauge className="w-full h-full text-oxidized-teal mechanical-tick" />
            </div>
            ...
            <img 
              ...
              className="w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 object-contain gear-counter"
              width="320"
              height="320"
              loading="eager"
              itemProp="logo"

...
const SplitHeroSection = () => {
  ...
  return (
    <section
      className="relative overflow-hidden hero bg-cover bg-center px-4 sm:px-6 py-8 sm:py-10 md:py-14 lg:py-20"
      style={{
        backgroundImage: 'url(/lovable-uploads/e3cfb4ba-d1c1-45ec-9d05-cbdd7e1bcacc.png)',
        minHeight: 'clamp(560px, 80vh, 900px)',
      }}
    >
      ...
      <div className="relative z-10 container mx-auto">
        <h1 className="sr-only">STEaM LOGIC Studio AB</h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 items-start gap-4 sm:gap-5 lg:gap-10">
          {/* Left Panel - Plumberella */}
          <Card
            id="featured-book-card"
            className="card bg-parchment hover:border-brass-dark transition-all duration-300 hover:scale-105 shadow-brass-drop relative overflow-hidden w-full max-w-[720px] mx-auto lg:mx-0"
          >
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="absolute top-4 right-4">
                <span className="px-4 py-2 bg-brass/90 text-parchment border border-brass-dark font-medium font-playfair flex items-center">
            ...
            <CardHeader>
              <CardTitle className="text-oxidized-teal text-3xl font-playfair drop-shadow-text-drop">
                {t('splitHero.plumberellaTitle')}
              </CardTitle>
              <CardDescription className="text-brass font-medium font-playfair text-lg">
                {t('splitHero.plumberellaDesc')}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                variant="steam"
                className="w-full min-h-[44px] font-playfair font-medium text-lg py-3"
          ...
          <Card
            id="ai-magic-card"
            className="card bg-parchment hover:border-brass-dark transition-all duration-300 hover:scale-105 shadow-brass-drop relative overflow-hidden w-full max-w-[820px] mx-auto lg:mx-0"
          >
            ...
            <CardContent className="relative">
              <div className="space-y-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-oxidized-teal font-semibold font-playfair">
                      {t('splitHero.aiStrategyTitle')}
                    </h4>
                    <p className="text-oxidized-teal/70 text-sm font-playfair">
                      {t('splitHero.aiStrategyDesc')}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Cog
                    className="w-5 h-5 text-brass mt-1 animate-spin"
                    style={{ animationDuration: '3s', animationDirection: 'reverse' }}
                  />
                  <div>
                    <h4 className="text-oxidized-teal font-semibold font-playfair">
                      {t('splitHero.aiCustomTitle')}
                    </h4>
                    <p className="text-oxidized-teal/70 text-sm font-playfair">
                      {t('splitHero.aiCustomDesc')}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-oxidized-teal font-semibold font-playfair">
                      {t('splitHero.aiWorkshopsTitle')}
                    </h4>
                    <p className="text-oxidized-teal/70 text-sm font-playfair">
                      {t('splitHero.aiWorkshopsDesc')}
                    </p>
                  </div>
                </div>
              </div>

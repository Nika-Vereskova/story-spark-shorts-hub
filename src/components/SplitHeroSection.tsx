        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="card bg-parchment hover:border-brass-dark transition-all duration-300 hover:scale-105 shadow-brass-drop relative overflow-hidden">
              ...
              <CardHeader>
                <CardTitle className="font-bold text-oxidized-teal text-3xl drop-shadow-text-drop">{t('splitHero.plumberellaTitle')}</CardTitle>
            ...
            <Card className="card bg-parchment hover:border-brass-dark transition-all duration-300 hover:scale-105 shadow-brass-drop relative overflow-hidden">
              ...
              <CardHeader className="relative">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <CardTitle className="font-bold text-oxidized-teal text-3xl drop-shadow-text-drop">{t('splitHero.aiTitle')}</CardTitle>

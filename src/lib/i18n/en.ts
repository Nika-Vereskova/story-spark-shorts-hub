...
**Next post drops in 2 days**—stay tuned! 🚀`
  ...
  projects: {
    ...
    europeCapitals: {
      ...
      countryToCapital: "Learn Countries",
      capitalToCountry: "Learn Capitals",
      showHints: "Show mnemonic clues",
      multipleChoice: "Choose from Options",
      typed: "Write the Answer",
      reset: "Clear Selection",
      mapNote: "Click on countries to hear their names and capitals. Countries are grouped by region.",
      reviewLater: "Review later",
      score: "Score",
      finalScore: "Final Score",
      tryAgain: "Play Again!",
      tip: "Your progress (missed answers) is saved locally on this device.",
      clickToFlip: "Tap to reveal; after revealing, tap left for previous or right for next.",
      studyMode: "Study Mode",
      progress: "Progress",
      quizTime: "Quiz Time!",
      quizDescription: "Test your knowledge with a fun quiz!",
      quizType: "Quiz Type",
      direction: "Direction",
      question: "Question",
      exploreMap: "Explore the Map",
      clickToHear: "Click countries to hear their names",
      selected: "Selected",
      tipTitle: "Progress Saved",
      ...
      excellent: "Excellent! You're a geography expert!",
      good: "Good job! You know your capitals!",
